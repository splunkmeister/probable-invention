...
.PARAMETER TargetOU
  Distinguished name of the OU to link, e.g. "OU=Domain Controllers,DC=company,DC=com". Leave blank to skip linking.
.PARAMETER WhatIf
  Build/stage everything but do not link the GPO.
#>
[CmdletBinding(SupportsShouldProcess)]
param(
    [string] $TargetOU   = "OU=Domain Controllers,DC=company,DC=com",
